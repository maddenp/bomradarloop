...
radars = {
    ...
    '05': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [WA] Carnarvon
    '06': {'delta': 360, 'frames': 6, 'res': (1, 2, 3, 4)}, # [WA] Geraldton
    '07': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [WA] Wyndham
    '08': {'delta': 360, 'frames': 6, 'res': (1, 2, 3, 4)}, # [QLD] Gympie (Mt Kanigan)
    '09': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [NT] Gove
    '14': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [SA] Mt Gambier
    '15': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [WA] Dampier
    '16': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [WA] Pt Hedland
    '17': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [WA] Broome
    '19': {'delta': 360, 'frames': 6, 'res': (1, 2, 3, 4)}, # [QLD] Cairns
    '22': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [QLD] Mackay
    '23': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [QLD] Gladstone
    '24': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [QLD] Bowen
    '25': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [NT] Alice Springs
    '27': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [SA] Woomera
    '28': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [NSW] Grafton
    '29': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [WA] Learmonth
    '30': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [VIC] Mildura
    '31': {'delta': 360, 'frames': 6, 'res': (1, 2, 3, 4)}, # [WA] Albany
    '32': {'delta': 360, 'frames': 6, 'res': (1, 2, 3, 4)}, # [WA] Esperance
    '33': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [SA] Ceduna
    '36': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [QLD] Gulf of Carpentaria (Mornington Is)
    '38': {'delta': 360, 'frames': 6, 'res': (1, 2, 3, 4)}, # [WA] Newdegate
    '39': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [WA] Halls Creek
    '40': {'delta': 360, 'frames': 6, 'res': (1, 2, 3, 4)}, # [NSW] Canberra (Captains Flat)
    '41': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [QLD] Willis Island
    '42': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [NT] Katherine (Tindal)
    '44': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [WA] Giles
    '46': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [SA] Adelaide (Sellicks Hill)
    ...
    '53': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [NSW] Moree
    '55': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [NSW] Wagga Wagga
    '56': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [QLD] Longreach
    ...
    '67': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [QLD] Warrego
    '68': {'delta': 360, 'frames': 6, 'res': (1, 2, 3)},    # [VIC] Bairnsdale
    '69': {'delta': 360, 'frames': 6, 'res': (1, 2, 3, 4)}, # [NSW] Namoi (Blackjack Mountain)
    '70': {'delta': 360, 'frames': 6, 'res': (1, 2, 3, 4)}, # [WA] Perth (Serpentine)
    '71': {'delta': 360, 'frames': 6, 'res': (1, 2, 3, 4)}, # [NSW] Sydney (Terrey Hills)
    '72': {'delta': 360, 'frames': 6, 'res': (1, 2, 3, 4)}, # [QLD] Emerald
    '73': {'delta': 360, 'frames': 6, 'res': (1, 2, 3, 4)}, # [QLD] Townsville (Hervey Range)
